                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <div class="text-center mt-2">
                                        Kamu Belum Punya Akun ? <a href="register.php">Klik Disini Ya</a> 
                                    </div>
                                    <hr>
                                    <a href="login2.php" class="btn btn-success btn-block btn-user mt-3">Login Admin/Petugas</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
if(isset($_POST['login'])){
    ...
    include 'koneksi.php';
    $cek = mysqli_query($koneksi,"SELECT * FROM masyarakat WHERE username='$username'");
